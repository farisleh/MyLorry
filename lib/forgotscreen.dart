...
String urlLogin = "http://blazzerjet.com/mylorry/php/reset_password.php";
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Text("We will send the Confirmation Code through Email account\nPlease type your Email account below."),
                    ...
                    GestureDetector(
                      onTap: _onBack,
                      child: Text("Home Page".toUpperCase(), style: TextStyle(
                        color: Theme.of(context).primaryColor,
